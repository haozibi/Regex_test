...
class Ui_bzizi(object):
    def setupUi(self, bzizi):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../../../.pic/pngico/animal_bug_insect_ladybird_128px_1951_easyicon.net.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.button_ok.setGeometry(QtCore.QRect(600, 30, 85, 27))
        self.button_ok.setObjectName(_fromUtf8("button_ok"))
        self.button_about = QtGui.QPushButton(bzizi)
        self.button_about.setGeometry(QtCore.QRect(600, 110, 85, 27))
        ...
        self.button_input = QtGui.QPushButton(bzizi)
        self.button_input.setGeometry(QtCore.QRect(600, 70, 85, 27))
    ...
    def retranslateUi(self, bzizi):
        ...
        self.button_input.setText(_translate("bzizi", "导入", None))
